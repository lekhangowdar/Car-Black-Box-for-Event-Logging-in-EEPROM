...
void set_time(char menu_key)
{
    ...
    if(tc_flag == 1)
    {
        ...
        clcd_print("Time changed",(0x80 + (0)));
    ...
    else
    {
        ...
        if(field == 0)
        {
            ...
            clcd_putch(hr/10+48,(0xC0 + (3)));
            clcd_putch(':',(0xC0 + (5)));
            clcd_putch(min%10+48,(0xC0 + (7)));
            clcd_putch(min/10+48,(0xC0 + (6)));
            clcd_putch(':',(0xC0 + (8)));
            if(blink)
            {
                clcd_putch(secs%10+48,(0xC0 + (10)));
                clcd_putch(secs/10+48,(0xC0 + (9)));
            }
            else
            {
                clcd_print("  ",(0xC0 + (9)));
        ...
        if(menu_key == 11)
        {
            ...
            if(time3 > 200)
            {
                ...
                write_ds1307(0x02, hr_reg);
                write_ds1307(0x01, min_reg);
                write_ds1307(0x00, sec_reg);
                timeout = 3;
                tc_flag = 1;
                clcd_write(0x01, 0);
            }
