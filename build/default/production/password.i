...
unsigned char pass[]="1111";
unsigned char input_pass[4];
...
void password(char key)
{
    if (flag<4 && attempt > 0 && wait_f == 0)
    {
        ...
        if (blink_delay++ > 200)
        {
            ...
            if (blink_state)
            {
                clcd_print("_               ", (0xC0 + (flag)));
            }
            else
            {
                clcd_print("                ", (0xC0 + (flag)));
            }
        }
    }
    else if(flag == 4)
    {
        ...
        if(attempt_f == 0)
        {
            clcd_print("CORRECT PASSWORD", (0xC0 + (0)));
            attempt = 3;
            flag = 0;
        ...
        else if (attempt<3)
        {
            if(attempt == 2)
            {
                ...
                clcd_print("2 Attempts left ", (0xC0 + (0)));
            }
            else if(attempt == 1)
            {
                clcd_print("WRONG PASSWORD  ", (0x80 + (0)));
                clcd_print("1 Attempt left  ", (0xC0 + (0)));
            }
