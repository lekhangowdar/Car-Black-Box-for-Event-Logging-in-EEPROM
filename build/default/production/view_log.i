...
void view_log(char key)
{
    ...
    clcd_putch(view_ind + '0', (0xC0 + (0)));
    clcd_putch(' ', (0xC0 + (1)));
    clcd_putch(view_array[view_ind][0], (0xC0 + (2)));
    clcd_putch(view_array[view_ind][1], (0xC0 + (3)));
    clcd_putch(':', (0xC0 + (4)));
    clcd_putch(view_array[view_ind][2], (0xC0 + (5)));
    clcd_putch(view_array[view_ind][3], (0xC0 + (6)));
    clcd_putch(':', (0xC0 + (7)));
    clcd_putch(view_array[view_ind][4], (0xC0 + (8)));
    clcd_putch(view_array[view_ind][5], (0xC0 + (9)));
    clcd_putch(' ', (0xC0 + (10)));
    clcd_putch(view_array[view_ind][6], (0xC0 + (11)));
    clcd_putch(view_array[view_ind][7], (0xC0 + (12)));
    clcd_putch(' ', (0xC0 + (13)));
    clcd_putch(view_array[view_ind][8], (0xC0 + (14)));
    clcd_putch(view_array[view_ind][9], (0xC0 + (15)));
    key = read_switches(0);
