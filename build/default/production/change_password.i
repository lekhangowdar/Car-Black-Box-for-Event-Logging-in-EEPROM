...
extern char main_f;
extern unsigned char pass[5], ev_ind;
...
void change_pass(char key)
{
    ...
    else if (re_flag == 1 )
    {
        ...
        if (count1 == 4 && same == 0)
        {
            ...
            {
                clcd_write(0x01, 0);
                clcd_print("PSWD NOT MATCHED", (0xC0 + (0)));
                re_flag = 0;
                same = 0;
                go_back_f = 1;
            }
            ...
            {
                clcd_print("PASSWORD UPDATE ", (0x80 + (0)));
                clcd_print("SUCCESSFUL      ", (0xC0 + (0)));
                write_ext_eeprom(200, repa[0]);
    ...
    if(count1 < 4 && go_back_f == 0)
        if (blink_delay++ > 200)
        {
            ...
            if (blink_state)
            {
                clcd_print("_               ", (0xC0 + (count1)));
            }
            else
            {
                clcd_print("                ", (0xC0 + (count1)));
            }
        }
}
